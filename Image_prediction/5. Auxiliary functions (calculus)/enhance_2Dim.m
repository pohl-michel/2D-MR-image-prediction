...
% pixels. It enhances the contrast of the image following the algorithm used in ImageJ and
...
% License : 3-clause BSD License
    ...
    absolute_max_value = (2^8 - 1); % image coded in 8 bits
    
    
    [H, L] = size(input_image);
    input_image = int16(input_image); %line added on 03/08/2021
