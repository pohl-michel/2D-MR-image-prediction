...
beh_par.COMPUTE_OPTICAL_FLOW = false;   % Compute and save (as .mat files) optical flow at every time step
beh_par.SAVE_OF_JPG = false;            % Save optical flow images as jpg files
...
beh_par.EVALUATE_IN_ROI = false;     % Evaluate prediction errors only within the ROI
