...
% License : 3-clause BSD License
    ...
    eval_results = eval_of_warp_corr( of_type_idx, im_par, OF_par, path_par, warp_par, pred_par, br_model_par, disp_par, beh_par, eval_results, my_empty_struct);                   
    ...
    for hrz_idx = 1:hppars.nb_hrz_val
        ...
        of_type_idx = 2; % warping with the signal reconstructed from PCA on the test set
        my_empty_struct = struct();
        eval_results_h = eval_of_warp_corr( of_type_idx, im_par, OF_par, path_par_h, warp_par_h, pred_par_h, br_model_par_h, disp_par, beh_par, eval_results_h, my_empty_struct); 
        ...
        of_type_idx = 3; % warping with the predicted optical flow on the test set
        ...
        eval_results_h = eval_of_warp_corr( of_type_idx, im_par, OF_par, path_par_h, warp_par_h, pred_par_h, br_model_par_h, disp_par, beh_par, eval_results_h, time_signal_pred_results);
