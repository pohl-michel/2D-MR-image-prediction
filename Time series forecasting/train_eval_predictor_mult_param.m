...
% License : 3-clause BSD License
    ...
    for hrz_idx = 1:hppars.nb_hrz_val
        ...
        error_aux_tab(expl_idx_tab) = Inf;
            % parameters for which there is an explosion are not taken into account
        ...
        % on fait l'évaluation sur le test set avec les meilleurs params
        ...
        pred_par_cell{hrz_idx}.t_eval_start = 1 + pred_par_cell{hrz_idx}.tmax_cv; % car je veux faire l'eval sur l'ensemble de test
