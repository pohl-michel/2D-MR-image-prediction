...
%             % test
%             hppars.nb_runs_cv = 20;
%             hppars.nb_runs_eval_test = 100;
%             
%             hppars.horizon_tab = [1, 5];
% 
%             hppars.other(1).name = 'SHL';
%             hppars.other(1).val = [4, 20];   
%             hppars.SHL_hyppar_idx = 1; % used for time calculation analysis            
%             
%             hppars.other(2).name = 'learn_rate';
%             hppars.other(2).val = [0.005, 0.02];
%             
%             hppars.other(3).name = 'rnn_state_space_dim'; 
%             hppars.other(3).val = [30, 180];      
%             hppars.state_space_hyppar_idx = 3; % used for time calculation analysis             
    ...
    hppars.nb_additional_params = numel(hppars.other);
        % useful for writing the log file for instance  
