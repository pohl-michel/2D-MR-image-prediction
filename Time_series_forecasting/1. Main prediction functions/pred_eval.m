...
% License : 3-clause BSD License
    ...
    switch pred_par.pred_meth
        case {'multivariate linear regression', 'univariate linear regression', 'SVR', 'transformer', 'population_transformer'}
            pred_par.t_first_prediction = pred_par.tmax_training + 1; % offline learning
